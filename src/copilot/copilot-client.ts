    ...
    const sidekickSession = await this.sdkClient.createSession({
      ...
      systemMessage: {
        ...
        content: [
          ...
          '- Be willing to save stable final findings from substantial assistant answers, especially when the answer includes researched conclusions, dates, lists, or cited sources that are likely to matter again.',
          '- Preserve retrieval anchors. Keep important names, acronyms, aliases, products, schools, districts, sites, and likely future search terms in the subject, details, or tags instead of over-compressing them away.',
          '- Distill the reusable conclusion plus the key search terms, not the whole transcript.',
